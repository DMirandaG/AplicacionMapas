...
public class ServicioLocalizacion extends Service implements LocationListener {
    ...
    public void onLocationChanged(Location location) {
        ...
        extra.putDouble(AppMediador.CLAVE_LATITUD, latitude);
        extra.putDouble(AppMediador.CLAVE_LONGITUD, longitude);
        appMediador.sendBroadcast(AppMediador.AVISO_LOCALIZACION_GPS, extra);
    }

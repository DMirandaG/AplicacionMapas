...
public class Modelo implements IModelo {
    ...
    public void actualizarMapa() {
        ...
        if (adaptadorBD !=null){
            ArrayList<DatoMarca> adaptadorMarca = adaptadorBD.obtenerRegistros();
            extras = new Bundle();
            extras.putSerializable(AppMediador.CLAVE_MARCAS, adaptadorMarca);
        }
        adaptadorBD.cerrar();
    ...
    @Override
    public void agregarMarca(Object marca) {
        Bundle extras = null;
        adaptadorBD = adaptadorBD.abrir();
        if (adaptadorBD !=null){
            Object[] datosMarca = (Object[]) marca;

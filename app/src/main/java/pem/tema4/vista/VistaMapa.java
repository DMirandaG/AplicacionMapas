...
public class VistaMapa extends FragmentActivity implements OnMapReadyCallback, IVistaMapa, GoogleMap.OnMapClickListener, GoogleMap.OnMarkerClickListener {
    ...
    public void actualizarMapa(Object datos) {
        ...
        Object[] datos1 = (Object[]) datos;
        double latitud = (double)datos1[0];
        double longitud = (double)datos1[1];
        String titulo = (String)datos1[2];
    ...
    // ES UN MÉTODO @Override
    @Override
    public void mostrarDialogo(final Object datos) {
        ...
        final View vistaDialogo = this.getLayoutInflater().inflate(R.layout.dialogo_marca, null);
        ...
        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                datos1[0] = latitud;
                datos1[1] = longitud;
                datos1[2] = titulo.getText().toString();
                presentadorMapa.actualizarMapa(AppMediador.ESTADO_AGREGAR_MARCA, datos1);
    ...
    public void mostrarMenu(final Object marca) {
        ...
        final Marker temp = (Marker)marca;
    ...
    public void borrarMarca(Object marca) {
        Marker marcaSeleccionada = (Marker) marca;
        //presentadorMapa.actualizarMapa(AppMediador.ESTADO_INICIAL, marcaSeleccionada);
        marcaSeleccionada.remove();
